...
<div class="col-sm-6 mt-5  mx-3 jumbotron mx-auto"> <br>
    ...
    <form action="" method="POST">
        ...
        <div class="form-group col-md-6 mx-auto">
            ...
            <input type="text" class="form-control text-center mx-auto" id="username" name="username" value="<?php echo isset($row['username']) ? $row['username'] : ''; ?>">
        </div>

        <div class="form-group col-md-6 mx-auto">
            <label for="inputPassword">Password : </label>
            <input type="password" class="form-control text-center mx-auto" id="password" name="password" value="<?php echo isset($row['password']) ? $row['password'] : ''; ?>">
        </div>
