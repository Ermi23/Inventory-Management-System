...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<h2 class="text-center">Talem Cake And Beakery Order Receipt</h2>';
        echo '<hr>';
        ...
        echo '</div>';
        // Buttons
        echo '<div class="d-print-none" style="display: flex; gap: 10px; align-items: center;">';
        echo '<a href="Recipt.php" onclick="window.print(); return false;">
                <button class="btn bg-tan">Print</button>
              </a>';
        echo '<a href="OrderHistory.php">
